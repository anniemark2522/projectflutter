...
class _MoodCalendarState extends State<MoodCalendar> {
  ...
  DateTime? _selectedDay;//ใช้เเค่เเช็คการลือกวันได้อย่างเดียว 
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            Align(
          alignment: Alignment.bottomRight, // Position the FAB at the bottom right
          child: Padding(
            padding: EdgeInsets.all(16), // Add padding to avoid touching the edges
              ...
              backgroundColor: _selectedDay != null &&
                  ...
                  ? (_isSavedToday
                      ? const Color.fromARGB(
                          255, 168, 168, 168) // สีเทาหากบันทึกแล้ว
                      : const Color.fromARGB(
                          255, 247, 167, 187)) // สีปกติหากยังไม่ได้บันทึก
                  : const Color.fromARGB(
                      255, 168, 168, 168), // สีเทาหากไม่ใช่วันปัจจุบัน
              onPressed: () {
                if (_selectedDay != null &&
                    _selectedDay!.year == DateTime.now().year &&
                    _selectedDay!.month == DateTime.now().month &&
